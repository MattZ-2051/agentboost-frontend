	...
	<g id="vuesax/outline/copy-success">
		<g id="copy-success">
			<path
				...
				fill="url(#paint0_linear_1534_440)"
			/>
			<path
				id="Vector_2"
				...
				fill="url(#paint1_linear_1534_440)"
			/>
			<path
				id="Vector_3"
				...
				fill="url(#paint2_linear_1534_440)"
			/>
		</g>
	</g>
	<defs>
		<linearGradient
			id="paint0_linear_1534_440"
			x1="7.25"
			y1="1.25"
			x2="23.069"
			y2="1.58266"
