...
<div
	...
	class="w-[247px] h-[152px] bg-zinc-900 absolute top-10 -right-4 z-50 rounded-[10px] shadow p-4 flex flex-col gap-y-4"
>
	...
	<div class="w-full h-[1px] border border-zinc-800" />
	<Button
		label="Logout"
