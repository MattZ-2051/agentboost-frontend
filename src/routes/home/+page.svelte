...
<div class="mt-12 h-full w-full">
  <h1 class="text-5xl text-center mt-4 underline underline-offset-8">
    Welcome To AgentBoost AI
  </h1>
  <div />
  <div class="container mt-24 mx-auto md:px-6">
    ...
    <section class="mb-32 text-center">
      <h1 class="text-4xl mb-12">Capabalitites</h1>

      <div class="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
        <div class="mb-12 md:mb-0">
          <div
            class="mb-6 inline-block rounded-md bg-secondary-400 p-4 text-primary"
          >
            <svg
    ...
    <section class="text-center mb-32">
      <h1 class="text-4xl mb-12">Updates</h1>
      <p>
    ...
    <section class="text-center mb-32">
      <h1 class="text-4xl mb-12">Lorem Ipsum</h1>
      <p>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
        veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
