		...
		<Card height="h-full" classes="disabled:card-hover">
			<div class="p-4">
				<ul class="list grid grid-cols-2">
					<li>
						<span class="font-bold">Bathrooms - </span><span> {$listing.bathrooms}</span>
					</li>
					<li>
						<span class="font-bold">Bedrooms - </span><span>{$listing.bedrooms}</span>
					</li>
					<li>
					...
					<li>
						<span class="font-bold">Lot Size - </span><span>{$listing.lotSize}</span>
					</li>
					<li>
						<span class="font-bold">Square Footage - </span><span>{$listing.squareFootage}</span>
					</li>
					<li>
						<span class="font-bold">Year Built - </span><span>{$listing.yearBuilt}</span>
					</li>
					<li>
						<span class="font-bold">Property Type - </span><span>{$listing.propertyType}</span>
					</li>
					<!-- <li>
